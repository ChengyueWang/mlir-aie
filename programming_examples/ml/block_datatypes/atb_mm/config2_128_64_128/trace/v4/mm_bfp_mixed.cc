...
void matmul_vectorized_bfp16(bfp16ebs8 *__restrict pA, bfp16ebs8 *__restrict pB,
  ...
  for (int run =0; run < run_num ; run ++){
    ...
    pC0Out_stream.seek(0);
    aie::block_vector_output_buffer_stream<bfp16ebs8, 64> pC1Out_stream(pC);
    pC1Out_stream.seek(8);
    aie::block_vector_output_buffer_stream<bfp16ebs8, 64> pC0In_stream(pC);
    pC0In_stream.seek(0);
    aie::block_vector_output_buffer_stream<bfp16ebs8, 64> pC1In_stream(pC);
    pC1In_stream.seek(8);
