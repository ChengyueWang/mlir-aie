...
void matmul_vectorized_bfp16(bfp16ebs8 *__restrict pA, bfp16ebs8 *__restrict pB,
  ...
  for (int run =0; run < run_num ; run ++){
    ...
    for (int block_row = 0; block_row < m / 8; block_row = block_row + 2) {
      ...
      // AIE_LOOP_RANGE(8, )
      for (int block_col = 0; block_col < n / 8; block_col = block_col + 2 * 2) {
        ...
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex4) A0_data_bfp = pA_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex5) A1_data_bfp = pA_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex6) B0_data_bfp = pB_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex7) B1_data_bfp = pB_stream.pop();

        // aie::accum<accfloat, 64> chess_storage(dm0) acc0_data(pC0In_stream.pop());
        // aie::accum<accfloat, 64> chess_storage(dm1) acc1_data(pC0In_stream.pop());
        // aie::accum<accfloat, 64> chess_storage(dm2) acc2_data(pC1In_stream.pop());
        // aie::accum<accfloat, 64> chess_storage(dm3) acc3_data(pC1In_stream.pop());
        ...
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex8) A0_data_bfp_pong = pA_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex9) A1_data_bfp_pong = pA_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex10) B0_data_bfp_pong = pB_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex11) B1_data_bfp_pong = pB_stream.pop();
        ...
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex0) loadC0_2 = pC0In_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex1) loadC1_2 = pC0In_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex2) loadC2_2 = pC1In_stream.pop();
        aie::block_vector<bfp16ebs8, 64> chess_storage(ex3) loadC3_2 = pC1In_stream.pop();
        ...
        // aie::block_vector<bfp16ebs8, 64> acc0_data_temp = pC0In_stream.pop();
        // aie::accum<accfloat, 64> chess_storage(dm0) acc0_data3(acc0_data_temp);
        // acc1_data = pC0In_stream.pop();
        // acc2_data = pC1In_stream.pop();
        // acc3_data = pC1In_stream.pop();


        aie::accum<accfloat, 64> chess_storage(dm0) acc0_data2(loadC0_2);
        aie::accum<accfloat, 64> chess_storage(dm1) acc1_data2(loadC1_2);
        aie::accum<accfloat, 64> chess_storage(dm2) acc2_data2(loadC2_2);
        aie::accum<accfloat, 64> chess_storage(dm3) acc3_data2(loadC3_2);


        // aie::accum<accfloat, 64> chess_storage(dm0) acc0_data2(pC0In_stream.pop());
        // aie::accum<accfloat, 64> chess_storage(dm1) acc1_data2(pC0In_stream.pop());
        // aie::accum<accfloat, 64> chess_storage(dm2) acc2_data2(pC1In_stream.pop());
        // aie::accum<accfloat, 64> chess_storage(dm3) acc3_data2(pC1In_stream.pop());
        ...
        acc0_data2 = mac_8x8_8x8T(A0_data_bfp, B0_data_bfp, acc0_data2);
        acc1_data2 = mac_8x8_8x8T(A0_data_bfp, B1_data_bfp, acc1_data2);
        acc2_data2 = mac_8x8_8x8T(A1_data_bfp, B0_data_bfp, acc2_data2);
        acc3_data2 = mac_8x8_8x8T(A1_data_bfp, B1_data_bfp, acc3_data2);
        A0_data_bfp = pA_stream.pop();
        A1_data_bfp = pA_stream.pop();
        B0_data_bfp = pB_stream.pop();
        B1_data_bfp = pB_stream.pop();
        acc0_data2 = mac_8x8_8x8T(A0_data_bfp_pong, B0_data_bfp_pong, acc0_data2);
        acc1_data2 = mac_8x8_8x8T(A0_data_bfp_pong, B1_data_bfp_pong, acc1_data2);
        acc2_data2 = mac_8x8_8x8T(A1_data_bfp_pong, B0_data_bfp_pong, acc2_data2);
        acc3_data2 = mac_8x8_8x8T(A1_data_bfp_pong, B1_data_bfp_pong, acc3_data2);
        A0_data_bfp_pong = pA_stream.pop();
        A1_data_bfp_pong = pA_stream.pop();
        B0_data_bfp_pong = pB_stream.pop();
        B1_data_bfp_pong = pB_stream.pop();
        ...
        pC0Out_stream.push(acc0_data2.template to_vector<bfp16ebs8>());
        pC0Out_stream.push(acc1_data2.template to_vector<bfp16ebs8>());
        pC1Out_stream.push(acc2_data2.template to_vector<bfp16ebs8>());
        pC1Out_stream.push(acc3_data2.template to_vector<bfp16ebs8>());
