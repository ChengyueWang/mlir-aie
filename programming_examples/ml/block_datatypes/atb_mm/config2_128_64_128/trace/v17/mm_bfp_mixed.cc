  ...
  for (int run =0; run < run_num ; run ++){
    ...
    for (int block_row = 0; block_row < m / 8; block_row = block_row + 2) {
      ...
      for (int block_col = 0; block_col < n / 8; block_col = block_col + 2 * 2) {
        ...
        aie::accum<accfloat, 64> chess_storage(dm4) acc0_data2(pC0In_stream.pop());
        aie::accum<accfloat, 64> chess_storage(dm0) acc1_data2(pC0In_stream.pop());
        aie::accum<accfloat, 64> chess_storage(dm1) acc2_data2(pC1In_stream.pop());
        aie::accum<accfloat, 64> chess_storage(dm2) acc3_data2(pC1In_stream.pop());
