module {
  aie.device(npu2_1col) {
    ...
    memref.global "public" @out0_cons : memref<16000xi32>
    memref.global "public" @out0 : memref<16000xi32>
    memref.global "public" @in1_cons : memref<8xi32>
    memref.global "public" @in1 : memref<8xi32>
    memref.global "public" @in0_cons : memref<16000xi32>
    memref.global "public" @in0 : memref<16000xi32>
    %shim_noc_tile_0_0 = aie.tile(0, 0)
    %mem_tile_0_1 = aie.tile(0, 1)
    %tile_0_2 = aie.tile(0, 2)
    %out1_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "out1_buff_0"} : memref<8xi32> 
    %out1_buff_1 = aie.buffer(%tile_0_2) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "out1_buff_1"} : memref<8xi32> 
    ...
    %out0_buff_0 = aie.buffer(%mem_tile_0_1) {address = 0 : i32, mem_bank = 0 : i32, sym_name = "out0_buff_0"} : memref<16000xi32> 
    %out0_buff_1 = aie.buffer(%mem_tile_0_1) {address = 65536 : i32, mem_bank = 1 : i32, sym_name = "out0_buff_1"} : memref<16000xi32> 
    %out0_prod_lock_0 = aie.lock(%mem_tile_0_1, 2) {init = 2 : i32, sym_name = "out0_prod_lock_0"}
    %out0_cons_lock_0 = aie.lock(%mem_tile_0_1, 3) {init = 0 : i32, sym_name = "out0_cons_lock_0"}
    %in1_cons_buff_0 = aie.buffer(%tile_0_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "in1_cons_buff_0"} : memref<8xi32> 
    %in1_cons_buff_1 = aie.buffer(%tile_0_2) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "in1_cons_buff_1"} : memref<8xi32> 
    ...
    %in0_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 131072 : i32, mem_bank = 2 : i32, sym_name = "in0_cons_buff_0"} : memref<16000xi32> 
    %in0_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 196608 : i32, mem_bank = 3 : i32, sym_name = "in0_cons_buff_1"} : memref<16000xi32> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c6 step %c2 {
        ...
        scf.for %arg1 = %c0_2 to %c8_3 step %c1_4 {
          ...
          %c1_i32 = arith.constant 1 : i32
          %1 = arith.addi %0, %c1_i32 : i32
          memref.store %1, %out1_buff_1[%arg1] : memref<8xi32>
        }
        aie.use_lock(%in1_cons_prod_lock_0, Release, 1)
        aie.use_lock(%out1_cons_lock_0, Release, 1)
      }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%in0_cons_buff_0 : memref<16000xi32>, 0, 16000)
      aie.use_lock(%in0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%in0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in0_cons_buff_1 : memref<16000xi32>, 0, 16000)
      aie.use_lock(%in0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb7:  // 2 preds: ^bb6, ^bb8
      ...
      aie.dma_bd(%out0_buff_0 : memref<16000xi32>, 0, 16000)
      aie.use_lock(%out0_prod_lock_0, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%out0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%out0_buff_1 : memref<16000xi32>, 0, 16000)
      aie.use_lock(%out0_prod_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
