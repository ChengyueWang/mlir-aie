module {
  aie.device(npu2) {
    ...
    %in0_cons_buff_1 = aie.buffer(%mem_tile_0_1) {sym_name = "in0_cons_buff_1"} : memref<96000xi32> 
    ...
    %out1_cons_buff_1 = aie.buffer(%mem_tile_1_1) {sym_name = "out1_cons_buff_1"} : memref<8xi32> 
    %out1_cons_prod_lock_0 = aie.lock(%mem_tile_1_1, 0) {init = 2 : i32, sym_name = "out1_cons_prod_lock_0"}
    %out1_cons_cons_lock_0 = aie.lock(%mem_tile_1_1, 1) {init = 0 : i32, sym_name = "out1_cons_cons_lock_0"}
    %out1_cons_buff_0 = aie.buffer(%mem_tile_1_1) {sym_name = "out1_cons_buff_0"} : memref<8xi32> 
