module {
  aie.device(npu1) {
    ...
    %out0_buff_0 = aie.buffer(%mem_tile_1_1) {sym_name = "out0_buff_0"} : memref<64000xi32> 
    %out0_buff_1 = aie.buffer(%mem_tile_1_1) {sym_name = "out0_buff_1"} : memref<64000xi32> 
    ...
    %in0_cons_buff_0 = aie.buffer(%mem_tile_0_1) {sym_name = "in0_cons_buff_0"} : memref<64000xi32> 
    %in0_cons_buff_1 = aie.buffer(%mem_tile_0_1) {sym_name = "in0_cons_buff_1"} : memref<64000xi32> 
