module {
  aie.device(npu2_1col) {
    ...
    memref.global "public" @out0_cons : memref<18000xi32>
    memref.global "public" @out0 : memref<18000xi32>
    memref.global "public" @in1_cons : memref<8xi32>
    memref.global "public" @in1 : memref<8xi32>
    memref.global "public" @in0_cons : memref<18000xi32>
    memref.global "public" @in0 : memref<18000xi32>
    ...
    %out0_buff_0 = aie.buffer(%mem_tile_0_1) {sym_name = "out0_buff_0"} : memref<18000xi32> 
    %out0_buff_1 = aie.buffer(%mem_tile_0_1) {sym_name = "out0_buff_1"} : memref<18000xi32> 
    ...
    %in0_cons_buff_0 = aie.buffer(%mem_tile_0_1) {sym_name = "in0_cons_buff_0"} : memref<18000xi32> 
    %in0_cons_buff_1 = aie.buffer(%mem_tile_0_1) {sym_name = "in0_cons_buff_1"} : memref<18000xi32> 
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%in0_cons_buff_0 : memref<18000xi32>, 0, 18000)
      aie.use_lock(%in0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%in0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in0_cons_buff_1 : memref<18000xi32>, 0, 18000)
      aie.use_lock(%in0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb7:  // 2 preds: ^bb6, ^bb8
      ...
      aie.dma_bd(%out0_buff_0 : memref<18000xi32>, 0, 18000)
      aie.use_lock(%out0_prod_lock_0, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%out0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%out0_buff_1 : memref<18000xi32>, 0, 18000)
      aie.use_lock(%out0_prod_lock_0, Release, 1)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
